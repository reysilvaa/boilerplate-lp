...
function initialMode(): PricingMode {
  ...
  try {
    return new URLSearchParams(window.location.search).get('mode') === 'tutor' ? 'tutor' : 'self';
  } catch {
    return 'self';
  }
}
...
return;
    ...
    const onScroll = (): void => {
      ...
      if (pct > 0.25) {
 open(); window.removeEventListener('scroll', onScroll); 
}
    };
    window.addEventListener('scroll', onScroll, { passive: true });

    return () => {
 window.clearTimeout(timer); window.removeEventListener('scroll', onScroll); 
};
  }, []);
  ...
  return (
    <>
      ...
      <div className="[min-height:100vh] [background:#fff] [font-family:Nunito,system-ui,sans-serif]">
        ...
        {/* Fixed Header: Urgency Banner + Navbar */}
        <div className="[position:fixed] [top:0] [left:0] [right:0] [z-index:50]">
          {flashVisible ? (<>
            <TrackedCTA ref={bannerRef} id="urgency-banner" href="#pricing" zone="sticky" action="scroll" label="Flash Sale Banner" className="[display:flex] [align-items:center] [justify-content:center] [flex-wrap:nowrap] [gap:8px] [background:#C10707] [padding:8px_12px] [text-align:center] [text-decoration:none] [white-space:nowrap] [overflow:hidden] max-[500px]:[padding:10px_12px]">
          ...
          <header className={`[border-bottom:1px_solid_#f3f4f6] [transition:all_0.3s] ${scrolled ? '[background:rgba(255,255,255,0.95)] [box-shadow:0_4px_12px_rgba(0,0,0,0.08)] [backdrop-filter:blur(8px)]' : '[background:#fff] [box-shadow:0_1px_3px_rgba(0,0,0,0.05)]'}`}>
            <div className="[max-width:1152px] [margin:0_auto] [height:64px] [display:flex] [align-items:center] [justify-content:space-between] [padding:0_24px]">
              <TrackedCTA href="#" zone="nav" action="scroll" label="Nav Logo" className="[display:flex] [align-items:center] [text-decoration:none]">
        ...
        <div className="[background:#F3F3F3] [padding:32px_0] [overflow:hidden]">
            ...
            <div className="[overflow:hidden] [mask-image:linear-gradient(to_right,transparent,black_6%,black_94%,transparent)] [-webkit-mask-image:linear-gradient(to_right,transparent,black_6%,black_94%,transparent)]">
              <div className="[display:flex] [width:max-content] [animation:infiniteScroll_30s_linear_infinite]">
                ...
                <img src="/assets/logos/unair.webp" alt="Universitas Airlangga" loading="lazy" width="110" height="64" className="[width:110px] [height:64px] [margin:0_20px] [flex-shrink:0] [object-fit:contain]" />
                <img src="/assets/logos/unpad.webp" alt="Universitas Padjadjaran" loading="lazy" width="110" height="64" className="[width:110px] [height:64px] [margin:0_20px] [flex-shrink:0] [object-fit:contain]" />
          ...
          <div className="[max-width:1152px] [margin:0_auto]">
            ...
            <div className="[text-align:center]">
              <div className="[display:flex] [flex-wrap:wrap] [gap:12px] [justify-content:center]">
                <TrackedCTA href="#pricing" zone="midpage" action="scroll" label="Agitation Gabung Sekarang" className="[display:inline-flex] [align-items:center] [justify-content:center] [gap:8px] [font-weight:700] [border-radius:16px] [padding:14px_28px] [font-size:16px] [color:#fff] [background:#D70808] [box-shadow:0_4px_20px_rgba(215,8,8,0.35)] [text-decoration:none]">Gabung Sekarang →</TrackedCTA>
                <TrackedCTA href="#testimonials" zone="midpage" action="scroll" label="Agitation Lihat Bukti Alumni" className="[display:inline-flex] [align-items:center] [justify-content:center] [gap:8px] [font-weight:700] [border-radius:16px] [padding:14px_28px] [font-size:16px] [color:#151515] [border:2px_solid_#D70808] [text-decoration:none]">Lihat Bukti Alumni →</TrackedCTA>
              </div>
        ...
        <section id="lms" className="[background:#fff] [padding:80px_24px]">
          <div className="[max-width:1152px] [margin:0_auto]">
            ...
            <div className="[text-align:center]">
              ...
              <div className="[display:flex] [flex-wrap:wrap] [gap:12px] [justify-content:center]">
                <TrackedCTA href="#pricing" zone="midpage" action="scroll" label="LMS Gabung Sekarang" className="[display:inline-flex] [align-items:center] [justify-content:center] [gap:8px] [font-weight:700] [border-radius:16px] [padding:14px_28px] [font-size:16px] [color:#fff] [background:#D70808] [box-shadow:0_4px_20px_rgba(215,8,8,0.35)] [text-decoration:none]">Gabung Sekarang →</TrackedCTA>
                <TrackedCTA href="#testimonials" zone="midpage" action="scroll" label="LMS Lihat Bukti Alumni" className="[display:inline-flex] [align-items:center] [justify-content:center] [gap:8px] [font-weight:700] [border-radius:16px] [padding:14px_28px] [font-size:16px] [color:#151515] [border:2px_solid_#D70808] [text-decoration:none]">Lihat Bukti Alumni →</TrackedCTA>
              </div>
              <div className="[margin-top:12px] [display:flex] [align-items:center] [justify-content:center] [flex-wrap:wrap] [gap:8px_12px]">
                <span className="[display:flex] [align-items:center] [gap:4px] [font-size:12px] [font-weight:600] [color:#6b7280]">★★★★★<span className="[margin-left:4px]">4.9/5 Google Review</span></span>
                <span className="[font-size:12px] [color:#6b7280]">•</span><span className="[font-size:12px] [font-weight:600] [color:#6b7280]">45.000+ Alumni Sukses</span>
          ...
          <div className="[background:#fff] [padding:80px_24px]">
            <div className="[max-width:1152px] [margin:0_auto]">
              ...
              <div className="[margin-top:40px] [text-align:center]">
                ...
                <TrackedCTA href="#pricing" zone="midpage" action="scroll" label="Alumni Story Gabung Sekarang" className="[display:inline-flex] [align-items:center] [justify-content:center] [gap:8px] [font-weight:700] [border-radius:16px] [padding:14px_28px] [font-size:16px] [color:#fff] [background:#D70808] [box-shadow:0_4px_20px_rgba(215,8,8,0.35)] [text-decoration:none]">Gabung Sekarang →</TrackedCTA>
              </div>
            </div>
          </div>
        </section>
      ...
      Catatan: Jika berhalangan hadir LIVE ZOOM, jangan khawatir — materi bisa diakses di rekaman ZOOM.</p>
            ...
            <div className="[max-width:512px] [margin:0_auto] [text-align:center]">
              ...
              <div className="[display:flex] [flex-wrap:wrap] [gap:12px] [justify-content:center]">
                <TrackedCTA href="https://wa.me/6285255499299?text=Halo%20Admin%20Full%20Bright%20Indonesia.%20Saya%20minat%20mau%20daftar%20kelas%20TOEFL.%20Saya%20mau%20tanya-tanya%20dulu." target="_blank" rel="noopener noreferrer" zone="faq" action="whatsapp" label="FAQ Tanya Admin WA" className="[display:inline-flex] [align-items:center] [justify-content:center] [gap:8px] [font-weight:700] [border-radius:16px] [padding:14px_28px] [font-size:16px] [color:#fff] [background:#D70808] [box-shadow:0_4px_20px_rgba(215,8,8,0.35)] [text-decoration:none]">Chat Via WA →</TrackedCTA>
                <TrackedCTA href="#testimonials" zone="faq" action="scroll" label="FAQ Lihat Bukti Alumni" className="[display:inline-flex] [align-items:center] [justify-content:center] [gap:8px] [font-weight:700] [border-radius:16px] [padding:14px_28px] [font-size:16px] [color:#151515] [border:2px_solid_#D70808] [text-decoration:none]">Lihat Bukti Alumni →</TrackedCTA>
              </div>
            </div>
          </div>
        </section>
                ...
                <ul className="[list-style:none] [margin:0] [padding:0] [display:flex] [flex-direction:column] [gap:16px]">
                    ...
                    <li className="[display:flex] [align-items:flex-start] [gap:12px]">
                      ...
                      <div>
                        ...
                        <TrackedCTA href="https://wa.me/6281959486507" target="_blank" rel="noopener noreferrer" zone="footer" action="whatsapp" label="Footer WA Ms. Aini" className="[font-size:12px] [color:#9ca3af] [text-decoration:none]">+62 819-5948-6507</TrackedCTA>
                      </div>
                    </li>
                    ...
                    <li className="[display:flex] [align-items:flex-start] [gap:12px]">
                      ...
                      <div>
                        ...
                        <TrackedCTA href="https://wa.me/6288744875322" target="_blank" rel="noopener noreferrer" zone="footer" action="whatsapp" label="Footer WA Mr. Choiri" className="[font-size:12px] [color:#9ca3af] [text-decoration:none]">+62 887-4487-5322</TrackedCTA>
                      </div>
                    </li>
                    ...
                    <li className="[display:flex] [align-items:flex-start] [gap:12px]">
                      ...
                      <div>
                        ...
                        <TrackedCTA href="https://wa.me/6285255499299" target="_blank" rel="noopener noreferrer" zone="footer" action="whatsapp" label="Footer WA Ms. Fini" className="[font-size:12px] [color:#9ca3af] [text-decoration:none]">+62 852-5549-9299</TrackedCTA>
                      </div>
                    </li>
        ...
        {rpOpen ? (<>
          <div className="[position:fixed] [inset:0] [z-index:100] [display:flex] [align-items:flex-end] [justify-content:center] [background:rgba(21,21,21,0.45)] [animation:fbFadeInUp_0.2s_ease]" onClick={closeReturnPopup}>
            <div className="[position:relative] [width:100%] [max-width:480px] [max-height:60vh] [overflow-y:auto] [background:#fff] [border-radius:24px_24px_0_0] [padding:22px_22px_28px] [box-shadow:0_-12px_40px_rgba(0,0,0,0.18)] [animation:fbSheetUp_0.25s_ease]" onClick={(e) => e.stopPropagation()}>
              ...
              {rpSelected !== null ? (<>
                <TrackedCTA href={waUrl(RETURN_WA_MSGS[rpSelected ?? 0])} target="_blank" rel="noopener noreferrer" zone="floating" action="whatsapp" label={`Return Popup WA: ${RETURN_OPTIONS[rpSelected ?? 0]}`} className="[display:flex] [align-items:center] [justify-content:center] [gap:8px] [width:100%] [font-size:14px] [font-weight:700] [color:#fff] [background:#16a34a] [border-radius:12px] [padding:13px_16px] [text-decoration:none] [box-sizing:border-box] [margin-bottom:14px]">💬 Konsultasi via WhatsApp →</TrackedCTA>
